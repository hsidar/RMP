...
class FurnituresControllerTest < ActionController::TestCase
  ...
  test "should create furniture" do
    assert_difference('Furniture.count') do
      post :create, furniture: { raccoon_id: @furniture.raccoon_id, style: @furniture.style, type: @furniture.type }
    end
  ...
  test "should update furniture" do
    patch :update, id: @furniture, furniture: { raccoon_id: @furniture.raccoon_id, style: @furniture.style, type: @furniture.type }
    assert_redirected_to furniture_path(assigns(:furniture))
  end
